    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          >
            Instantly create high-converting content for any platform using
            Gemini AI. Enter a topic, tweak your preferences, and watch the
            magic happen!
          </motion.p>
        </div>
          ...
          <div className="space-y-6">
            ...
            {error && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="p-3 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-lg"
              >
                {error}
              </motion.div>
            )}
            ...
            {generated.titles.length > 0 && (
              ...
              >
                  ...
                  <div className="space-y-3">
                    {generated.titles.map((title, index) => (
                      <motion.div
                        ...
                        className="flex items-center justify-between p-4 bg-indigo-50 dark:bg-gray-700 rounded-lg"
                      >
                ...
                <motion.div variants={itemVariants} className="mt-6 flex gap-3">
                  <button
                    onClick={() => {
                      const content = `# contentspark Flash Content\n\nTopic: ${
                        input.topic
        ...
        <div className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
          contentspark {new Date().getFullYear()} • Powered by Gemini AI
        </div>
      </motion.div>
    </div>
  );
